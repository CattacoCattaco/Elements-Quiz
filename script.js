...
let elements = [
    ...
    new ChemElement("Rb", "Rubidium", 37, SOLID, ALKALI_METAL),
    new ChemElement("Sr", "Strontium", 38, SOLID, ALKALINE_EARTH_METAL),
    new ChemElement("Y", "Yttrium", 39, SOLID, TRANSITION_METAL),
    new ChemElement("Zr", "Zirconium", 40, SOLID, TRANSITION_METAL),
    new ChemElement("Nb", "Niobium", 41, SOLID, TRANSITION_METAL),
    new ChemElement("Mo", "Molybdenum", 42, SOLID, TRANSITION_METAL),
    new ChemElement("Tc", "Technetium", 43, SOLID, TRANSITION_METAL),
    new ChemElement("Ru", "Ruthenium", 44, SOLID, TRANSITION_METAL),
    new ChemElement("Rh", "Rhodium", 45, SOLID, TRANSITION_METAL),
    new ChemElement("Pd", "Palladium", 46, SOLID, TRANSITION_METAL),
    new ChemElement("Ag", "Silver", 47, SOLID, TRANSITION_METAL),
    new ChemElement("Cd", "Cadmium", 48, SOLID, TRANSITION_METAL),
    new ChemElement("In", "Indium", 49, SOLID, BASIC_METAL),
    new ChemElement("Sn", "Tin", 50, SOLID, BASIC_METAL),
    new ChemElement("Sb", "Antimony", 51, SOLID, METALLOID),
    new ChemElement("Te", "Tellurium", 52, SOLID, METALLOID),
    new ChemElement("I", "Iodine", 53, SOLID, HALOGEN),
    new ChemElement("Xe", "Xenon", 54, SOLID, NOBLE_GAS),
]
